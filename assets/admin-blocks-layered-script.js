(function (wp) {
    ...
    blocks.registerBlockType(
            "mintfaq/mintfaq-layered-faq",
            {
                title: __("Mint FAQ Layered", "mint-faq"),
                description: __("Display FAQs for Layered Layout.", "mint-faq"),
                category: "widgets",
                attributes: {
                    shortcode_id: {
                        type: "string",
                ...
                edit: function(props){
                    return [
                        el(
                            wp.serverSideRender,
                            {
                                block: "mintfaq/mintfaq-layered-faq",
									...
									el(
										...
										el(
											...
											el(
												components.SelectControl,
												{
													label: __("Category Skin", "mint-faq"),
													labelPosition: "top",
													options: block_options.get_skins(),
													value: props.attributes.category_skin,
													onChange: (value) => {props.setAttributes({category_skin: value});}
												},
												null
											)
										),
										...
										el(
											...
											el(
												components.SelectControl,
												{
													label: __("Category Icon", "mint-faq"),
													labelPosition: "top",
													options: block_options.get_symbols_list(),
													value: props.attributes.category_icon,
													onChange: (value) => {props.setAttributes({category_icon: value});}
												},
												null
											)
										),
										el(
											...
											el(
												components.SelectControl,
												{
													label: __("Category Icon Alignment", "mint-faq"),
													labelPosition: "top",
													options: block_options.get_symbols_align(),
													value: props.attributes.category_icon_align,
													onChange: (value) => {props.setAttributes({category_icon_align: value});}
												},
												null
											)
										),
										...
										el(
											...
											el(
												components.SelectControl,
												{
													label: __("FAQ Icon Alignment", "mint-faq"),
													labelPosition: "top",
													options: block_options.get_symbols_align(),
